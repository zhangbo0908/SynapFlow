...
vi.mock('../../src/renderer/src/store/useMindmapStore', () => ({
  useMindmapStore: vi.fn((selector) => selector({
...
vi.mock('../../src/renderer/src/hooks/useAutoSave', () => ({
  useAutoSave: () => ({ isSaving: false, lastSavedTime: null, markAsSaved: vi.fn() }),
}));

// Mock Child Components to simplify testing
vi.mock('../../src/renderer/src/components/CanvasWorkspace', () => ({ default: () => <div data-testid="canvas-workspace" /> }));
vi.mock('../../src/renderer/src/components/PropertiesPanel', () => ({ default: () => <div data-testid="properties-panel" /> }));
vi.mock('../../src/renderer/src/components/SheetBar', () => ({ default: () => <div data-testid="sheet-bar" /> }));
vi.mock('../../src/renderer/src/components/SaveStatus', () => ({ default: () => <div data-testid="save-status" /> }));
vi.mock('../../src/renderer/src/components/ExportDropdown', () => ({ default: () => <div data-testid="export-dropdown" /> }));
vi.mock('../../src/renderer/src/components/WelcomeScreen', () => ({ default: () => <div data-testid="welcome-screen" /> }));
