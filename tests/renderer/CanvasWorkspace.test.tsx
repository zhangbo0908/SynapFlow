...
describe('CanvasWorkspace', () => {
    ...
    useMindmapStore.setState({
      data: {
        ...
        sheets: [{
            ...
            rootId: 'root',
            nodes: {
                root: { id: 'root', text: 'Central Topic', x: 0, y: 0, width: 100, height: 40, children: ['child1'], isRoot: true },
                child1: { id: 'child1', text: 'Child Node', x: 200, y: 0, width: 100, height: 40, children: [], parentId: 'root' }
            },
            theme: 'default',
  ...
  it('handles pan on drag', () => {
    ...
    const state = useMindmapStore.getState().data;
    const initialOffset = state.sheets.find(s => s.id === state.activeSheetId)!.editorState.offset;
    ...
    const offset = newState.sheets.find(s => s.id === newState.activeSheetId)!.editorState.offset;
    ...
    useMindmapStore.setState({
      data: {
        ...
        sheets: [{
            ...
            rootId: 'root',
            nodes: {
                root: { id: 'root', text: 'Root', x: 100, y: 0, width: 100, height: 40, children: ['child1'], isRoot: true },
                child1: { id: 'child1', text: 'Child', x: 100, y: 100, width: 100, height: 40, children: [], parentId: 'root' }
            },
            theme: 'default',
            layout: 'orgChart',
            editorState: { zoom: 1, offset: { x: 0, y: 0 } }
    ...
    useMindmapStore.setState({
        data: {
          ...
          sheets: [{
              ...
              rootId: 'root',
              nodes: {
                  root: { id: 'root', text: 'Root', x: 0, y: 0, width: 100, height: 40, children: ['child1'], isRoot: true },
                  child1: { id: 'child1', text: 'Child', x: 150, y: 0, width: 100, height: 40, children: [], parentId: 'root' }
              },
              theme: 'default',
              layout: 'logic',
              editorState: { zoom: 1, offset: { x: 0, y: 0 } }
