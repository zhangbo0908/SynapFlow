                ...
                {Object.entries(THEME_PRESETS).map(([key, theme]) => (
                  ...
                  >
                    <div
                      ...
                      style={{
                        backgroundColor: theme.rootStyle.backgroundColor,
                        borderColor: theme.rootStyle.borderColor,
                        borderWidth: theme.rootStyle.borderWidth,
                      }}
                    ></div>
                    <div className="text-left">
                      <div className="text-sm font-medium text-ui-primary">
                        {theme.name}
                      </div>
                    </div>
                  </button>
            ...
            <div className="p-4 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    handleStyleChange("lineStyle", e.target.value)
                  }
                  className="w-full px-3 py-2 text-sm bg-panel text-ui-primary border border-ui-border rounded focus:ring-2 focus:ring-brand focus:outline-none"
                >
