...
const renderOffscreen = async (
  ...
  const styleConfig = {
    lineColor:
      computedStyle.getPropertyValue("--color-border-node").trim() ||
  ...
  root.render(
    ...
    >
      <MindmapRenderer
        ...
        nodes={nodes}
        layout={
          Object.values(nodes).find((n) => n.isRoot)?.style?.lineStyle ===
          "step"
            ? "orgChart"
            : "mindmap"
        } // Approximate layout or pass it?
...
export const exportToPng = async (
  ...
  return renderOffscreen(
    rootId,
    nodes,
    async (container, width, height, _minX, _minY) => {
      // ... config
